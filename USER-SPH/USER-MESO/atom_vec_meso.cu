...
MesoAtomVec::MesoAtomVec( LAMMPS *lmp ) :
    ...
    dev_coord( lmp, "MesoAtomVec::dev_coord" ),
    dev_force( lmp, "MesoAtomVec::dev_force" ),
    dev_veloc( lmp, "MesoAtomVec::dev_veloc" ),
    dev_virial( lmp, "MesoAtomVec::dev_virial" ),
...
//  dev_e_impro         ( lmp, "MesoAtomVec::dev_e_impro" ),
    ...
    dev_r_coord( lmp, "MesoAtomVec::dev_r_coord" ),
    dev_r_veloc( lmp, "MesoAtomVec::dev_r_veloc" ),
