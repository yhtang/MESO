...
DumpStyle(edpd/meso,DumpEDPD)

#else

#ifndef LMP_DUMP_EDPD_H
#define LMP_DUMP_EDPD_H

#include "dump.h"

namespace LAMMPS_NS {

class DumpEDPD : public Dump {
 public:
  DumpEDPD(LAMMPS *, int, char**);
 ...
 private:
  ...
  typedef void (DumpEDPD::*FnPtrHeader)(bigint);
  ...
  typedef void (DumpEDPD::*FnPtrPack)(int *);
  ...
  typedef void (DumpEDPD::*FnPtrData)(int, double *);
