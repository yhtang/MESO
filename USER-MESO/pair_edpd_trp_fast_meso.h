...
PairStyle(edpd/trp/fast/meso,MesoPairEDPDTRPFast)

#else

#ifndef LMP_MESO_PAIR_EDPD_TRP_FAST
#define LMP_MESO_PAIR_EDPD_TRP_FAST

#include "pair_edpd_trp_base_meso.h"

namespace LAMMPS_NS {

class MesoPairEDPDTRPFast : public MesoPairEDPDTRPBase, protected MesoPointers {
 public:
	MesoPairEDPDTRPFast(class LAMMPS *);
	virtual ~MesoPairEDPDTRPFast();
